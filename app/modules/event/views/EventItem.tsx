            ...
            <Card style={styles.container}>
                <Card.Content style={styles.body}>
                    ...
                    <View style={styles.bodyContent}>
                        <AppBoldText style={styles.titleText} numberOfLines={2} title={props.title} />
                        <AppBodyText style={styles.bodyText} numberOfLines={3} title={props.body} />
                        <AppBodyText style={styles.timeZoneText} numberOfLines={1} title={props.country} />
                    </View>
                </Card.Content>
            </Card>
            {renderLeftComponent()}
